...
from lib.dds_restaurants import RestaurantLoader
...
stg_bonus_system_restaurants_dag = sprint5_dds_restaurants_dag()
...
#     db_restaurant = Variable.get("MONGO_DB_USER")
...
#             cursor = conn.cursor()
#             cursor.execute('SELECT * FROM stg.ordersystem_restaurants;')
...
#             for row in data:
#                 cursor.execute(
#                     'INSERT INTO stg.bonussystem_restaurants (id, name, bonus_percent, min_payment_threshold) VALUES (%s, %s, %s, %s);',
#                     row
#                 )
